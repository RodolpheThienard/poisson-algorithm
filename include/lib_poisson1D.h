...
void richardson_alpha(f64 *AB, f64 *RHS, f64 *X, f64 *alpha_rich, i32 *lab, i32 *la,i32 *ku, i32*kl, f64 *tol, i32 *maxit, f64 *resvec, i32 *nbite);
void extract_MB_jacobi_tridiag(f64 *AB, f64 *MB, i32 *lab, i32 *la,i32 *ku, i32*kl, i32 *kv);
void extract_MB_gauss_seidel_tridiag(f64 *AB, f64 *MB, i32 *lab, i32 *la,i32 *ku, i32*kl, i32 *kv);
void richardson_MB(f64 *AB, f64 *RHS, f64 *X, f64 *MB, i32 *lab, i32 *la,i32 *ku, i32*kl, f64 *tol, i32 *maxit, f64 *resvec, i32 *nbite);
